...
function npa_css_js()
{
    ...
    wp_register_style('lightbox', get_template_directory_uri().'/lightbox.css', array(), 'null', 'all');
    wp_register_style('prettyPhoto', get_template_directory_uri() . '/css/prettyPhoto.css', array(), '1.0.0', 'all');
    ...
    wp_enqueue_script('lightbox-js', get_template_directory_uri().'/js/lightbox.min.js', array('jquery'), 'v2.7.1', 'false');
    
    wp_enqueue_script('jquery.prettyPhoto', get_template_directory_uri() . '/js/jquery.prettyPhoto.js', array('jquery'), '3.1.6', 'false');
