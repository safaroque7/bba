...
if (!empty($videolink)  or !empty($fbVideo)) { ?>
    ...
    <div class="position-relative">
        ...
        <?php } else { ?>
            <img src="<?php echo get_template_directory_uri() . '/images/111x120px.jpg' ?>" alt="<?php the_title(); ?>">
        <?php } ?>
        <div class="youtube_icon position-absolute w-100 h-100">
            <div class="icon_matter d-flex justify-content-center align-items-center h-100">
                <h1 class="h1 text-white mb-0"> <i class="fa fa-play-circle-o" aria-hidden="true"></i> </h1>
            </div>
        </div>
    </div>
<?php }