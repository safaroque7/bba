                            ...
                            <a href="<?php the_permalink();?>">
                                ...
                                <?php $lead_image = wp_get_attachment_image_src(get_post_thumbnail_id($post->ID),'large');?>
                                   <?php if(!empty($lead_image)){ ?>
                                    <img class="img-fluid border border-dark mb-2" src="<?php echo $lead_image[0]?>" alt="<?php the_title();?>">
                                    <?php } else { ?>
                                        <img class="mb-2" src="<?php echo get_template_directory_uri().'/images/266x418px.jpg'?>" alt="<?php the_title();?>">   
                             <?php } ?>
